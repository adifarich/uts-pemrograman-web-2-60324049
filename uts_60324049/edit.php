...
<body>
    ...
    $fetch = $conn->prepare("SELECT * FROM kategori WHERE id_kategori = ?");
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (empty($errors)) {
            ...
            if ($stmt->execute()) {
                ...
                $errors['global'] = 'Gagal memperbarui data: ' . $conn->error;
            }
            $stmt->close();
        }
    }
                        ...
                        <form method="POST" novalidate>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="deskripsi"
                                    ...
                                    rows="3"
                                    maxlength="200"
                                    placeholder="Keterangan kategori (opsional)"><?= htmlspecialchars($deskripsi ?? '') ?></textarea>
